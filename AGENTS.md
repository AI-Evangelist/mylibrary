...
mylibrary is a personal link-saving app that lets anyone capture, tag, and retrieve valuable knowledge links from a single clean interface.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "189678774+AI-Evangelist@users.noreply.github.com"
  git config user.name "AI-Evangelist"
  ```
